    ...
    <div class="col-lg-8">
        ...
        <div class="card mb-3 shadow-sm" style="border-radius: 12px; padding: 0 !important; border: 0 !important;">
            ...
            <div class="card-body">
                ...
                ?>
                <div class="mb-2 badge rounded-pill text-bg-secondary" style="font-size: 12px !important; margin-top: -15px !important; margin-bottom: 15px !important;"><span class="fw-semibold">Word Count:</span> <?= $wordCount ?></div>
