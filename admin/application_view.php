    ...
    <div class="col-lg-8">
        ...
        <div class="card mb-3 shadow-sm" style="border-radius: 12px; padding: 0 !important; border: 0 !important;">
            ...
            <div class="card-body">
                ...
                ?>
                <div class="mb-2" style="font-size: 14px !important; margin-top: -15px !important; margin-bottom: 15px !important; margin-left:40px;"><span class="fw-semibold">Word Count:</span> <?= $wordCount ?></div>
