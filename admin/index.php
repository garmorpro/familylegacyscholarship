...
<a href="<?= BASE_URL ?>/admin/auth/logout.php" class="me-1" title="Logout" style="color: #495057; font-size: 1.25rem; display: flex; align-items: center;">
        <i class="bi bi-box-arrow-in-left"></i>
    </a>
    <a href="settings.php" title="Settings" style="color: #495057; font-size: 1.25rem; display: flex; align-items: center;">
